...
public class FileMgr {
        ...
        try {
            ...
            if (contents != null) {
                for (int i = 0; i < contents.length; i++) {
                    ...
                    if (i % valsPerLine != 0 && (i + 1) % valsPerLine != 0 || i == 0)
    ...
    public void SaveConfigAs(String[] configContent, int AMOUNTOFSETTINGS) {
        String saveAsName = JOptionPane.showInputDialog(null, "Please enter a filename (without csv)", "File",JOptionPane.PLAIN_MESSAGE);
...
// deletes config file by using the File class, displays a success message
    public void ResetConfig() {
        ...
        file.delete();
        JOptionPane.showMessageDialog(null, "Config has been reset", "Message",JOptionPane.INFORMATION_MESSAGE);
    }
